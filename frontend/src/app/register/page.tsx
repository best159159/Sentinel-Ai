        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-20">
            ...
            >
                <div className="text-center mb-8">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center mx-auto mb-5 shadow-[0_8px_30px_rgb(16,185,129,0.3)] hover:scale-105 transition-transform duration-300">
                        <HiOutlineShieldCheck className="w-8 h-8 text-white" />
                    </div>
                    <h1 className="text-4xl font-black text-slate-800 tracking-tight mb-2">Join Sentinel AI</h1>
                    <p className="text-slate-500 font-medium">Create your account to start reporting</p>
                </div>
